...
use crate::types::{
    ...
    DirListResponse, DirRepoActionResponse, DirRestartResponse, ErrorResponse, GhosttyOpenMode,
...
mod tests {
    ...
    use crate::thought::runtime_config::ThoughtConfig;
    use crate::types::{
        DirRepoSearchResponse, RestState, SessionBatchMembership, StateEvidence, ThoughtSource,
