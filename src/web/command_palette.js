...
export function buildCommandPaletteItems({
  ...
  const baseItems = [
    ...
    { label: "Open native terminal", meta: "Ctrl+Shift+O", actionId: "open_native", disabled: !selected },
    { label: "Open Mermaid artifacts", meta: "Ctrl+Shift+M", actionId: "open_mermaid", disabled: !selected },
    { label: "Create session", meta: "Ctrl+Shift+N", actionId: "open_create", disabled: readOnly },
    { label: "Refresh sessions", meta: "Ctrl+Shift+R", actionId: "refresh" },
    { label: "Toggle follow published", meta: "Ctrl+Shift+P", actionId: "toggle_follow" },
    { label: "Thought config", meta: "Ctrl+Shift+T", actionId: "open_config" },
    { label: "Auth token", meta: "Ctrl+Shift+A", actionId: "open_auth" },
    { label: "Toggle Trogdor atlas", meta: "Ctrl+Shift+G", actionId: "toggle_trogdor_atlas" },
